<%@ page import="rs.webprogramming.homework_vi.model.Scope" %>
<%@ page import="rs.webprogramming.homework_vi.model.application.ApplicationDataWrapper" %>
<%@ page import="rs.webprogramming.homework_vi.model.request.RequestDataWrapper" %>
<%@ page import="rs.webprogramming.homework_vi.model.session.SessionDataWrapper" %>
...
<body>
<jsp:useBean id="applicationData" scope="application" class="rs.webprogramming.homework_vi.model.application.ApplicationData"/>
<jsp:useBean id="requestData" scope="request" class="rs.webprogramming.homework_vi.model.request.RequestData"/>
<jsp:useBean id="sessionData" scope="session" class="rs.webprogramming.homework_vi.model.session.SessionData"/>
